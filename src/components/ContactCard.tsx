  ...
  return (
    <div className="w-full space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
        ...
        <div className="lg:col-span-5 flex flex-col justify-between gap-3 sm:gap-4">
          {contactLinks.map((item, index) => (
            <motion.a
              ...
              className="p-3.5 sm:p-4 sm:py-4.5 rounded-2xl border flex items-center justify-between group transition-all duration-300 cursor-pointer hover:-translate-y-1 shadow-lg flex-1 min-w-0"
              style={{
            ...
            >
              <div className="flex items-center gap-3.5 min-w-0">
                <div
                  className="p-2.5 rounded-xl transition-colors group-hover:scale-110 shrink-0"
                ...
                <div className="min-w-0">
                  ...
                  <span className="text-xs font-semibold font-mono tracking-wide group-hover:text-[#064E3B] transition-colors block truncate">
                    {item.value}
                  </span>
                </div>
              </div>
              <ExternalLink
                className="w-4 h-4 opacity-40 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all shrink-0 ml-2"
                style={{ color: "#064E3B" }}
              />
            </motion.a>
          ))}
        ...
        <div
          className="lg:col-span-7 rounded-2xl border p-4 sm:p-6 md:p-8 relative overflow-hidden transition-all duration-700 shadow-2xl"
          style={{
            backgroundColor: dm ? "rgba(4,25,18,0.92)" : "rgba(255,250,240,0.95)",
            borderColor: dm ? "rgba(255,255,255,0.08)" : "rgba(6,78,59,0.15)",
            color: dm ? "#ffffff" : "#0D1F17",
        ...
        >
          ...
          <div
            ...
            style={{ background: "radial-gradient(circle, rgba(6,78,59,0.35) 0%, rgba(6,78,59,0.08) 50%, transparent 75%)" }}
          />
                ...
                >
                      ...
                      {opportunities.map(o => {
                        ...
                        return (
                          <button
                            ...
                            className="px-2.5 py-2 rounded-xl text-[11px] sm:text-xs font-semibold border transition-all cursor-pointer flex-1 min-w-[100px] text-center"
                            style={{
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      className="w-full text-xs px-4 py-2.5 rounded-xl border focus:outline-none transition-all resize-none sm:rows-4"
                      style={{
                        backgroundColor: dm ? "rgba(0,0,0,0.40)" : "rgba(248,231,201,0.60)",
                        borderColor: dm ? "rgba(255,255,255,0.06)" : "rgba(6,78,59,0.12)",
                        color: dm ? "#ffffff" : "#0D1F17",
                  ...
                  <div
                    className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 pt-3.5 sm:pt-4 border-t border-dashed"
                    style={{ borderColor: "rgba(6,78,59,0.2)" }}
                  >
                    <span
                      className="text-[9px] font-mono flex items-center gap-1.5 font-bold tracking-widest uppercase break-all"
                      style={{ color: dm ? "rgba(255,255,255,0.4)" : "rgba(13,31,23,0.5)" }}
                    >
                      <ShieldCheck className="w-4 h-4 shrink-0" style={{ color: "#064E3B" }} />
                    ...
                    <button
                      ...
                      className={`w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 sm:py-3 rounded-xl text-white font-semibold text-xs tracking-wide shadow-lg transition-all cursor-pointer ${status === 'sending' ? "opacity-70 cursor-not-allowed" : ""
                        }`}
                      style={{
                        backgroundColor: "#064E3B",
                        boxShadow: "0 4px 12px rgba(6,78,59,0.3)",
